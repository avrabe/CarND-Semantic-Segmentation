...
def test_for_kitti_dataset(data_dir):
    kitti_dataset_path = data_dir / 'data_road'
    training_labels_count = len(list(kitti_dataset_path.glob('training/gt_image_2/*_road_*.png')))
    training_images_count = len(list(kitti_dataset_path.glob('training/image_2/*.png')))
    testing_images_count = len(list(kitti_dataset_path.glob('testing/image_2/*.png')))
